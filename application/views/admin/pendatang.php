...
<div class="page-content--bgf7" id="app">
    ...
    <section class="statistic-chart">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="title-5 m-b-35">Data Pendatang</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <table id="myTable" class="table table-data3 table-borderless" data-toggle="table" data-url='<?= $TBL_URL ?>' data-toolbar="#toolbar" data-pagination="true" data-search="true" data-click-to-select="true" data-unique-id="nik">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="alamat">Alamat Asal</th>
                            ...
                            <div class="modal-content">
                                ...
                                <form id="myForm" onsubmit="return false" class="form-horizontal">
                                    <div class="modal-body">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="alamat" class=" form-control-label">Alamat Asal</label>
                                            </div>
                                            <div class="col-12 col-md-9">
    ...
    <script>
                    ...
                    nik: {
                        validators: {
                            ...
                            remote: {
                                ...
                                message: 'NIK telah terdaftar pada data pendatang'
                            }
                        }
                    }
                }
        ...
        function tambahData() {
            ...
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Tambah Data Pendatang')
        ...
        function editData() {
            ...
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Ubah Data Pendatang')
        ...
        function hapusData() {
            ...
            swal({
                    text: `${list.length} data pendatang akan dihapus?`,
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: "Batal",
                ...
                .then(hapus => {
                    ...
                    $.ajax('<?= base_url('api/deletePendatang') ?>', {
                        method: 'post',
                        data: {
                            list
                        }
        ...
        $('#btnSubmit').on('click', (e) => {
            ...
            if (aksi == 'Tambah') {
                ...
                $.ajax('<?= base_url('api/updatePendatang') ?>', {
                    method: 'post',
                    data
                }).then(res => {
                    swal(res.message, {
