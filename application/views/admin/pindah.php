...
<div class="page-content--bgf7" id="app">
    ...
    <section class="statistic-chart">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="title-5 m-b-35">Data Pindah</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <table id="myTable" class="table table-data3 table-borderless" data-toggle="table" data-url='<?= $TBL_URL ?>' data-toolbar="#toolbar" data-pagination="true" data-search="true" data-click-to-select="true" data-unique-id="nik">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="tanggal" data-formatter="tglFormatter" data-sortable="true">Tanggal Pindah</th>
                                    <th data-field="tujuan">Tujuan Pindah</th>
                                    <th data-field="alasan">Alasan Pindah</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form id="myForm" onsubmit="return false" class="form-horizontal">
                                    <div class="modal-body">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="tanggal" class=" form-control-label">Tanggal Pindah</label>
                                            </div>
                                            <div class="col-12 col-md-9 inpDate">
                                                <input type="date" name="tanggal" id="tanggal" placeholder="Masukkan tanggal pindah" class="form-control" data-bv-notempty="true" data-bv-notempty-message="Tanggal tidak boleh kosong">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="tujuan" class=" form-control-label">Tujuan Pindah</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <textarea name="tujuan" id="tujuan" placeholder="Masukkan tujuan" class="form-control" data-bv-notempty="true" data-bv-notempty-message="Tujuan tidak boleh kosong"></textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="alasan" class="form-control-label">Alasan Pindah</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <textarea name="alasan" id="alasan" placeholder="Masukkan alasan" class="form-control" data-bv-notempty="true" data-bv-notempty-message="Alasan tidak boleh kosong"></textarea>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
                    ...
                    nik: {
                        validators: {
                            ...
                            remote: {
                                ...
                                message: 'NIK telah terdaftar pada data pindah'
                            }
                        }
                    }
                }
        ...
        function tambahData() {
            ...
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Tambah Data Pindah')
        ...
        function editData() {
            ...
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Ubah Data Pindah')
        ...
        function hapusData() {
            ...
            swal({
                    text: `${list.length} data pindah akan dihapus?`,
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: "Batal",
                ...
                .then(hapus => {
                    ...
                    $.ajax('<?= base_url('api/deletePindah') ?>', {
                        method: 'post',
                        data: {
                            list
                        }
        ...
        $('#btnSubmit').on('click', (e) => {
            ...
            if (aksi == 'Tambah') {
                ...
                $.ajax('<?= base_url('api/updatePindah') ?>', {
                    method: 'post',
                    data
                }).then(res => {
                    swal(res.message, {
