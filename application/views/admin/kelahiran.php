...
<div class="page-content--bgf7" id="app">
    ...
    <section class="statistic-chart">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="title-5 m-b-35">Data Kelahiran</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive table-responsive-data2">
                        <table id="myTable" class="table table-data3 table-borderless" data-toggle="table" data-url='<?= $TBL_URL ?>' data-toolbar="#toolbar" data-pagination="true" data-search="true" data-click-to-select="true" data-unique-id="id">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="ayah">Nama Ayah</th>
                                    <th data-field="ibu">Nama Ibu</th>
                                    <th data-field="kk" data-sortable="true">Nomor KK</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9 inpDate">
                                                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" placeholder="Masukkan tanggal lahir" class="form-control" data-bv-notempty="true" data-bv-notempty-message="Tanggal lahir tidak boleh kosong">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select class="selectpicker show-tick form-control" data-style="btn-outline-secondary" data-live-search="true" id="kk" name="kk" title="- Pilih Nomor KK">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="ayah" placeholder="Silahkan pilih Nomor KK" class="form-control" disabled>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="ibu" placeholder="Silahkan pilih Nomor KK" class="form-control" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
            ...
            $form.bootstrapValidator({
                ...
                fields: {
                    kk: {
                        validators: {
                            notEmpty: {
                                message: 'Nomor KK belum dipilih'
                            }
                        }
                    }
                }
        ...
        function tambahData() {
            ...
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Tambah Data Kelahiran')
        ...
        function editData() {
            ...
            $form.trigger('reset');
            $modal.modal('toggle')
            $modalLabel.text('Form Ubah Data Kelahiran')
        ...
        function hapusData() {
            const list = $table.bootstrapTable('getSelections').map(v => v.id.toString())

            swal({
                    text: `${list.length} data kelahiran akan dihapus?`,
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: "Batal",
                ...
                .then(hapus => {
                    ...
                    $.ajax('<?= base_url('api/deleteKelahiran') ?>', {
                        method: 'post',
                        data: {
                            list
                        }
        ...
        $('#btnSubmit').on('click', (e) => {
            ...
            if (aksi == 'Tambah') {
                $.ajax('<?= base_url('api/kelahiran') ?>', {
                    ...
                    res.data['ayah'] = $('#ayah').val()
                    res.data['ibu'] = $('#ibu').val()

                    $table.bootstrapTable('append', res.data);
                })
            } else {
                data['where'] = $table.bootstrapTable('getSelections')[0].id

                $.ajax('<?= base_url('api/updateKelahiran') ?>', {
                    method: 'post',
                    data
                }).then(res => {
                    swal(res.message, {
